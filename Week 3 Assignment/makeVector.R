...
makeVector<-function(x=numeric()){
        ...
        set<-function (y){
                ...
                ## When set executes, first, it assigns the input argument 
                ## to the x object in the parent environment, and second, it 
                ## assigns a value of NULL to the m object in the 
                ## parent environment.
                x<<-y
